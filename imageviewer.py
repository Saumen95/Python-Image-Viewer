...
class ImageViewer(QtGui.QFrame):
    ...
    def __init__(self, pixmap=None, name=None):
        ...
        painter.fillRect(gridSize, gridSize, gridSize,
    ...
    def pixmap(self, pixmap):
        ...
        self._pixmapItem.setOffset(-pixmap.width() /
                                   2.0, -pixmap.height() / 2.0)
    ...
    def zoomFactor(self, newZoomFactor):
        if newZoomFactor < 1.0:
            self._pixmapItem.setTransformationMode(
...
[docs]    def enableScrollBars(self, enable):
        """Set visiblility of the view's scrollbars.
